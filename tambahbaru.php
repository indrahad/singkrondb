...
<head>
	...
	<title>Tambah|BosanKuliah</title>
</head>
...
<body>
	<div id="pembungkus" class="container" >
		<div id="raiso">
			...
			<h5 class="judul">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque minus ratione placeat, similique repudiandae sunt soluta at dolor est magnam autem voluptas libero facilis vitae, commodi veniam officiis. Ipsum, porro.</h5>
		</div>
		<!-- <nav id="navbar">
